...
// Given an input string which is an assignment statement with arithmetic operations(DMAS- Division, Multiplication, Addition, Subtraction), 
// write a C program to generate three address code by considering the following :
